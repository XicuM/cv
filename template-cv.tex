    ...
    \begin{tabular}{%
        ...
        \begin{minipage}[t]{%
            ...
            \begin{center}
                ...
                % Profile picture
                $if(assets.picture)$%
                    \circularimage[4.5cm]{../assets/$assets.picture$} \\[0.3cm]
                $endif$
                ...
                $for(professional_experience)$%
                    ...
                    $if(it.subpositions)$%
                        ...
                        $for(it.subpositions)$%
                            ...
                            \textsc{$it.position$}\dates{$it.dates.start$}{$it.dates.end$} \\
                            \hspace{1cm}$it.company$ $if(it.location)$- \textit{$it.location$}$endif$ \\[0.1cm]%
                            % Subposition details
